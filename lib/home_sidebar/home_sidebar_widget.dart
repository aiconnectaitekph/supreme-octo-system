...
import 'home_sidebar_model.dart';
export 'home_sidebar_model.dart';

class HomeSidebarWidget extends StatefulWidget {
  /// Create a sidebar that only shows when a icon is clisck then it slides from
  /// LTR smoothly and has close icon on top right that once tap it closes back
  /// sliing right smoothly
...
class _HomeSidebarWidgetState extends State<HomeSidebarWidget> {
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => HomeSidebarModel());
