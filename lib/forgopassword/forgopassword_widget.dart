...
class ForgopasswordWidget extends StatefulWidget {
  const ForgopasswordWidget({super.key});

  @override
  State<ForgopasswordWidget> createState() => _ForgopasswordWidgetState();
}
